...
**
** Created: Tue Jun 21 00:56:05 2016
...
public:
    ...
    void setupUi(QDialog *AxseScaleDialog)
    {
        ...
        AxseScaleDialog->resize(262, 227);
        ...
        lineEditMaxY->setGeometry(QRect(124, 33, 70, 20));
