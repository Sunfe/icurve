...
public:
    ...
    void setupUi(QDialog *AxseScaleDialog)
    {
        ...
        lineEditMaxY->setGeometry(QRect(125, 33, 70, 20));
        lineEditMinY = new QLineEdit(groupBox_2);
        lineEditMinY->setObjectName(QString::fromUtf8("lineEditMinY"));
        lineEditMinY->setGeometry(QRect(19, 33, 70, 20));
        label_7 = new QLabel(groupBox_2);
        label_7->setObjectName(QString::fromUtf8("label_7"));
        label_7->setGeometry(QRect(128, 15, 41, 16));
        label_8 = new QLabel(groupBox_2);
        label_8->setObjectName(QString::fromUtf8("label_8"));
        label_8->setGeometry(QRect(21, 14, 41, 20));
        lineEditMaxY->raise();
        label_7->raise();
        label_8->raise();
        lineEditMinY->raise();
    ...
    void retranslateUi(QDialog *AxseScaleDialog)
    {
        ...
        groupBox->setTitle(QApplication::translate("AxseScaleDialog", "X :", 0, QApplication::UnicodeUTF8));
        ...
        groupBox_2->setTitle(QApplication::translate("AxseScaleDialog", "Y :", 0, QApplication::UnicodeUTF8));
