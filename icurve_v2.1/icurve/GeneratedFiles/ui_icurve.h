...
**
** Created: Sat Sep 17 21:24:43 2016
...
public:
    ...
    void setupUi(QMainWindow *icurveClass)
    {
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icurve/images/save.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icurve/images/remove.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icurve/images/title.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionTitle->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icurve/images/color.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionColor->setIcon(icon5);
        actionWidth = new QAction(icurveClass);
        actionWidth->setObjectName(QString::fromUtf8("actionWidth"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icurve/images/line_width.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionWidth->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icurve/images/legend.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionLegend->setIcon(icon7);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icurve/images/style.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionStyle->setIcon(icon8);
        actionMarker = new QAction(icurveClass);
        actionMarker->setObjectName(QString::fromUtf8("actionMarker"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/icurve/images/marker.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionMarker->setIcon(icon9);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/icurve/images/filter.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionFilter->setIcon(icon10);
        actionFind = new QAction(icurveClass);
        actionFind->setObjectName(QString::fromUtf8("actionFind"));
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/icurve/images/find.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionFind->setIcon(icon11);
        actionShowAll = new QAction(icurveClass);
        actionShowAll->setObjectName(QString::fromUtf8("actionShowAll"));
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/icurve/images/show.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionShowAll->setIcon(icon12);
        actionExpand = new QAction(icurveClass);
        actionExpand->setObjectName(QString::fromUtf8("actionExpand"));
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/icurve/images/expand.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/icurve/images/delete.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/icurve/images/zoom.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionZoom->setIcon(icon15);
        ...
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/icurve/images/indicator.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionIndicator->setIcon(icon16);
        ...
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/icurve/images/info.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionInfo->setIcon(icon17);
        ...
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/icurve/images/scale.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAxseScale->setIcon(icon18);
        ...
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/icurve/images/hand.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionHandMove->setIcon(icon19);
        ...
        QIcon icon20;
        icon20.addFile(QString::fromUtf8(":/icurve/images/hide.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionHide->setIcon(icon20);
        ...
        QIcon icon21;
        icon21.addFile(QString::fromUtf8(":/icurve/images/refresh.png"), QSize(), QIcon::Normal, QIcon::Off);
